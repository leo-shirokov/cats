        ...
        messages: [
            {
                role: "user",
                content:
                    "Предложи пять кличек для животного суперагента и выведи их через запятую без нумерации. Животное: Кошка. Имена: Капитан Остролап, Агент Пушистик, Невероятный кот.",
            },
        ],
        temperature: 0.7,
    };
